...
3. 把你部门现有算子（定位 SDK / POI / 路径 / ETA）抽象成 5-8 个 tool。请写出每个的 input/output schema。
...
6. 假设你要在你部门做一个 *自然语言路径规划助手* 的 PoC：请给出 4 周的迭代规划（数据 / 工具 / 评测 / 上线指标）。

## 面试题

1. **(基础)** 为什么直接让 LLM 输出 lat/lng 不可靠？你会怎么校验？
